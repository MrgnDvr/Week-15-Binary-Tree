...
cout << "Tree Nodes: " << binaryTreePtr->getNumberOfNodes() <<
endl;
break;
case 4: //getRootData
cout << "Tree root node value: " << binaryTreePtr->getRootData()
<< endl;
break;
case 5: //setRootData
...
cout << "Remove value: ";
cin >> item;
cout << "Able to remove item: " << binaryTreePtr->remove(item) <<
endl;
break;
case 8: //clear
cout << "Cleared Tree";
...
cin >> item;
cout << "Is this entry in the tree? " << binaryTreePtr-
>getEntry(item) << endl;
break;
case 10: //contains
cout << "Check if tree contains: ";
cin >> item;
cout << "Does this tree contain " << item << "? " <<
binaryTreePtr->contains(item) << endl;
break;
case 11: //copy tree
default:
break;
